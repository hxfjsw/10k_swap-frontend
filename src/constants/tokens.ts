...
let tokens: ChainTokenList = {
  [StarknetChainId.MAINNET]: [
    ...
    new Token(StarknetChainId.MAINNET,"0x054f20994579087ecae673f3904d7ffd433707ddd6c658743901b1805cc62929",18,"RN","Raum Network")
  ],
  [StarknetChainId.TESTNET]: [
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [StarknetChainId.MAINNET]: [
    // new Token(StarknetChainId.MAINNET, '0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7', 18, 'ETH', 'Ether'),
    // new Token(StarknetChainId.MAINNET, '0x053c91253bc9682c04929ca02ed00b3e423f6710d2ee7e0d5ebb06f3ecf368a8', 6, 'USDC', 'USD Coin'),
    // new Token(StarknetChainId.MAINNET, '0x00da114221cb83fa859dbdb4c44beeaa0bb37c7537ad5ae66fe5e0efd20e6eb3', 18, 'DAI', 'Dai Stablecoin'),
    // new Token(StarknetChainId.MAINNET, '0x068f5c6a61780768455de69077e07e89787839bf8166decfbf92b645209c0fb8', 6, 'USDT', 'Tether USD'),
  ],
...
export function existToken(address:String):boolean{
  ...
  tokens[StarknetChainId.MAINNET].forEach(token => {
...
export function addToken(address: string, decimals: number, symbol: string, name: string) {
  ...
  tokens[StarknetChainId.MAINNET].push(
    new Token(StarknetChainId.MAINNET, address, decimals, symbol, name)
  );
...
export function loadTokens() {
  ...
  updatedTokens.forEach((token: { address: string; decimals: number; symbol: string; name: string; }) => {
    tokens[StarknetChainId.MAINNET].push(
      new Token(StarknetChainId.MAINNET, token.address, token.decimals, token.symbol, token.name)
    );
  });
}
