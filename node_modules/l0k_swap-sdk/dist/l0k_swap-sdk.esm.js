...
function validateAndParseAddress(address) {
  try {
    var checksummedAddress = validateAndParseAddress$1(address); // warning(address === checksummedAddress, `${address} is not checksummed.`)
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || 'INPUT') ? process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0;
