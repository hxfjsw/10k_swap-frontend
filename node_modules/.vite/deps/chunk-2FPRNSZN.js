import {
  ...
  warn
} from "./chunk-UAPKAEZS.js";
import {
  brushSingle,
  requestAnimationFrame_default
} from "./chunk-KQNBXEAG.js";
import {
  Animator_default,
...
var ChartView = function() {
  ...
  ChartView2.markUpdateMethod = function(payload, methodName) {
    inner2(payload).updateMethod = methodName;
  };
...
function renderTaskReset(context) {
  ...
  var updateMethod = payload && inner2(payload).updateMethod;
...
var dataColorPaletteTask = {
  ...
  overallReset: function(ecModel) {
    ...
    ecModel.eachSeries(function(seriesModel) {
      ...
      inner3(seriesModel).scope = colorScope;
    });
    ecModel.eachSeries(function(seriesModel) {
      ...
      var idxMap = {};
      var data = seriesModel.getData();
      var colorScope = inner3(seriesModel).scope;
      var stylePath = seriesModel.visualStyleAccessPath || "itemStyle";
      var colorKey = getDefaultColorKey(seriesModel, stylePath);
...
*/
//# sourceMappingURL=chunk-2FPRNSZN.js.map
