import {
  ...
  withModifiers,
  withScopeId
} from "./chunk-ZILIE5IE.js";
import "./chunk-S5KM4IGW.js";

// node_modules/vue-final-modal/dist/VueFinalModal.esm.js
function C(e) {
  return (C = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e2) {
    return typeof e2;
  } : function(e2) {
...
function j(e) {
  return function(e2) {
    ...
    "Object" === n && e2.constructor && (n = e2.constructor.name);
    if ("Map" === n || "Set" === n)
      return Array.from(e2);
...
var D = function() {
  ...
  return t = e, (n = [{ key: "lastElement", value: function() {
    ...
    if (function(e3) {
      return "Tab" === e3.key || 9 === e3.keyCode;
    }(e2)) {
      if (!e2.shiftKey)
...
var Y;
var q;
var G = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1);
var X = [];
var Z = false;
var J = 0;
var Q = -1;
var ee = function(e, t) {
  ...
  return function(e2) {
    ...
    (function(e3) {
      ...
      return !(0 === e3.scrollTop && t2 < 0 || e3.scrollTop + e3.clientHeight + t2 >= e3.scrollHeight && t2 > 0);
    }(e2, t) && (n = true);
  }), n;
};
var te = function(e) {
  ...
  if (e) {
    if (!X.some(function(t2) {
      ...
      X = [].concat(j(X), [n]), G ? (e.ontouchstart = function(e2) {
        1 === e2.targetTouches.length && (Q = e2.targetTouches[0].clientY);
      }, e.ontouchmove = function(t2) {
        1 === t2.targetTouches.length && function(e2, t3) {
          J = e2.targetTouches[0].clientY - Q, !te(e2.target) && (t3 && 0 === t3.scrollTop && J > 0 || function(e3) {
        ...
        if (void 0 === q) {
          var t2 = !!e2 && true === e2.reserveScrollBarGap, n2 = window.innerWidth - document.documentElement.clientWidth;
          if (t2 && n2 > 0) {
...
var re = function(e) {
  ...
  }), G ? (e.ontouchstart = null, e.ontouchmove = null, Z && 0 === X.length && (document.removeEventListener("touchmove", ne, F ? { passive: false } : void 0), Z = false)) : X.length || (void 0 !== q && (document.body.style.paddingRight = q, q = void 0), void 0 !== Y && (document.body.style.overflow = Y, Y = void 0))) : console.error("enableBodyScroll unsuccessful - targetElement must be provided when calling enableBodyScroll on IOS devices.");
};
var ie = function() {
};
var ae = "enter";
...
var de = { props: { name: { type: String, default: null }, modelValue: { type: Boolean, default: false }, ssr: { type: Boolean, default: true }, classes: { type: [String, Object, Array], default: "" }, overlayClass: { type: [String, Object, Array], default: "" }, contentClass: { type: [String, Object, Array], default: "" }, styles: { type: [Object, Array], default: function() {
  ...
  var s = u.emit, f = Symbol("vfm"), d = ref(null), c = ref(null), v = ref(null), p = ref(null), m = ref(null), y = ref(null), h = ref(null), b = new D(), g = ref(false), w = reactive({ modal: false, overlay: false, resize: false }), x = ref(null), E = ref(null), S = ref(false), O = ref({}), z = ref({}), M = ref(null), T = ref(null), C2 = ie, k2 = ie, A2 = computed(function() {
    return "string" == typeof l.overlayTransition ? { name: l.overlayTransition } : _({}, l.overlayTransition);
  }), B2 = computed(function() {
    return "string" == typeof l.transition ? { name: l.transition } : _({}, l.transition);
  }), P2 = computed(function() {
    return (l.hideOverlay || x.value === ue) && E.value === ue;
  }), I2 = computed(function() {
    return false === l.zIndex ? !!l.zIndexAuto && +l.zIndexBase + 2 * (h.value || 0) : l.zIndex;
  }), V2 = computed(function() {
    return _({}, false !== I2.value && { zIndex: I2.value });
  ...
  function W() {
    if (l.modelValue) {
      ...
      if (e || false === l.attach) {
        ...
        -1 !== t && l.api.openedModals.splice(t, 1), l.api.openedModals.push(F2()), h.value = l.api.openedModals.length - 1, q2(), l.api.openedModals.filter(function(e2) {
          return e2.uid !== f;
        ...
        false !== e && console.warn("Unable to locate target ".concat(l.attach));
    }
  }
  function Y2() {
    ...
    if (-1 !== e && l.api.openedModals.splice(e, 1), l.api.openedModals.length > 0) {
  ...
  function G2() {
    return false !== l.attach && ("string" == typeof l.attach ? !!window && window.document.querySelector(l.attach) : l.attach);
  }
  function X2() {
  ...
  function Q2(e, t) {
    ...
    return new Promise(function(o, r) {
      ...
      var i = "boolean" == typeof e ? e : !l.modelValue;
      i && 2 === n.length && (O.value = t), s("update:modelValue", i);
    });
  }
  function ee2(e) {
    e.stopPropagation();
    ...
    J2(e, t, "start");
    var i, a, u2, s2, f2 = N(e), d2 = c.value.getBoundingClientRect(), p2 = v.value.getBoundingClientRect(), m2 = "absolute" === window.getComputedStyle(v.value).position, y2 = $(z.value.top), h2 = $(z.value.left), b2 = function() {
      if (l.fitParent) {
  ...
  return watch(function() {
    ...
    var e;
    Y2(), l.lockScroll && c.value && re(c.value), null == d || null === (e = d.value) || void 0 === e || e.remove();
    ...
    T.value === c.value && "resize:move" !== M.value && (s("click-outside", X2({ type: "click-outside" })), l.clickToClose && s("update:modelValue", false));
  }, onEsc: function() {
...
var pe = ce(function(e, t, n, o, r, i) {
  return n.ssr || o.visible ? withDirectives((openBlock(), createBlock("div", { key: 0, ref: "root", style: o.bindStyle, class: ["vfm vfm--inset", [false === n.attach ? "vfm--fixed" : "vfm--absolute", { "vfm--prevent-none": n.preventClick }]], onKeydown: t[4] || (t[4] = withKeys(function() {
...
var Oe = function(e) {
  var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = 0 === be ? we : ge(), o = n.$vfm, r = n.VueFinalModal, i = n.ModalsContainer;
  be += 1;
